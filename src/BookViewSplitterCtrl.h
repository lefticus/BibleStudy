...
const wxEventType bsEVT_ACTIVE_MODULE_CHANGE = 5409;
const wxEventType bsEVT_BOOK_TREE_CHANGE = 5410;
const wxEventType bsEVT_SHOW_BIBLESTUDY = 5411;
const wxEventType bsEVT_SHOW_MODULE_LINK = 5412;
